...
export default function PhysicalChemicalAnalysisScreen() {
  ...
  const validateForm = () => {
    ...
    if (!formData.cryoscopy.trim()) newErrors.cryoscopy = 'Cryoscopy is required';
  ...
  return (
    <View className="flex-1 bg-gray-50">
      ...
      <View className="bg-blue-600 pt-12 pb-6 px-4 shadow-lg">
        <View className="flex-row items-center">
          ...
          <View>
            ...
            <Text className="text-blue-100">Physical-Chemical Analysis</Text>
          </View>
        </View>
      </View>
      ...
      <ScrollView className="flex-1 p-4">
        <View className="mb-6">
          <Text className="text-gray-700 text-lg font-semibold mb-2">Analysis Information</Text>
          ...
          <View className="flex-row flex-wrap gap-4">
            <View className="basis-[48%]">
              <Text className="text-gray-500 text-xs mb-1">Temperature (°C) *</Text>
              <TextInput
              ...
              />
              {errors.temperature ? <Text className="text-red-500 text-xs mt-1">{errors.temperature}</Text> : null}
            </View>
            ...
            <View className="basis-[48%]">
              ...
              />
              {errors.ph ? <Text className="text-red-500 text-xs mt-1">{errors.ph}</Text> : null}
            </View>
          </View>
          
          <View className="flex-row flex-wrap gap-4 mt-4">
            <View className="basis-[48%]">
              <Text className="text-gray-500 text-xs mb-1">Acidity (%) *</Text>
              <TextInput
              ...
              />
              {errors.acidity ? <Text className="text-red-500 text-xs mt-1">{errors.acidity}</Text> : null}
            </View>
            
            <View className="basis-[48%]">
              <Text className="text-gray-500 text-xs mb-1">Density (g/cm³) *</Text>
              <TextInput
                value={formData.density}
                onChangeText={(value) => handleInputChange('density', value)}
                placeholder="e.g. 1.032"
                keyboardType="numeric"
                className={`border rounded-lg p-3 ${errors.density ? 'border-red-500' : 'border-gray-300'}`}
              />
              {errors.density ? <Text className="text-red-500 text-xs mt-1">{errors.density}</Text> : null}
            </View>
          </View>
          
          <View className="flex-row flex-wrap gap-4 mt-4">
            <View className="basis-[48%]">
              <Text className="text-gray-500 text-xs mb-1">Cryoscopy (°C) *</Text>
              <TextInput
              ...
              />
              {errors.cryoscopy ? <Text className="text-red-500 text-xs mt-1">{errors.cryoscopy}</Text> : null}
            </View>
            
            <View className="basis-[48%]">
              <Text className="text-gray-500 text-xs mb-1">Fat (%) *</Text>
              <TextInput
                value={formData.fat}
          ...
          <View className="flex-row flex-wrap gap-4 mt-4">
            <View className="basis-[48%]">
              <Text className="text-gray-500 text-xs mb-1">Protein (%) *</Text>
              <TextInput
            ...
            <View className="basis-[48%]">
              ...
              />
              {errors.esd ? <Text className="text-red-500 text-xs mt-1">{errors.esd}</Text> : null}
            </View>
          </View>
          ...
          <View className="flex-row flex-wrap gap-4 mt-4">
            <View className="basis-[48%]">
              ...
              />
              {errors.est ? <Text className="text-red-500 text-xs mt-1">{errors.est}</Text> : null}
            </View>
            ...
            <View className="basis-[48%]">
              ...
              />
              {errors.lactose ? <Text className="text-red-500 text-xs mt-1">{errors.lactose}</Text> : null}
            </View>
          </View>
        </View>
        
        <View className="mb-6">
          <Text className="text-gray-700 text-lg font-semibold mb-2">Additional Information</Text>
          <Text className="text-gray-500 mb-4">Specify antibiotics, preservatives, and analyst</Text>
          
          <View className="bg-white rounded-xl p-4 shadow-sm mb-4">
            <Text className="text-gray-500 text-xs mb-1">Antibiotics</Text>
            <TextInput
          ...
          <View className="bg-white rounded-xl p-4 shadow-sm mb-4">
            <Text className="text-gray-500 text-xs mb-1">Preservatives</Text>
            <TextInput
              value={formData.preservatives}
              onChangeText={(value) => handleInputChange('preservatives', value)}
          ...
          <View className="bg-white rounded-xl p-4 shadow-sm">
            <Text className="text-gray-500 text-xs mb-1">Analyst *</Text>
            <TextInput
            ...
            />
            {errors.analyst ? <Text className="text-red-500 text-xs mt-1">{errors.analyst}</Text> : null}
          </View>
        </View>
      </ScrollView>
      ...
      <View className="p-4 bg-white border-t border-gray-200">
        ...
        >
          ...
          <Text className="text-white text-lg font-semibold">Save Report</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
